"""ver1-create database

Revision ID: ver1
Revises: 
Create Date: 2025-12-29 00:18:22.872771
...
def upgrade() -> None:
    ...
    sa.Column('content', sa.Boolean(), nullable=True),
    ...
    sa.Column('user1_id', sa.String(length=36), nullable=True),
    sa.Column('user2_id', sa.String(length=36), nullable=True),
